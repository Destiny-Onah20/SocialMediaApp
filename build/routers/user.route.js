...
userRoute.route("/gen-qrcode").get(authorization_1.userAuth, user_controller_1.qrcodeimage);
userRoute.route("/enable-two-factor-authentication").put(authorization_1.userAuth, user_controller_1.enableTwoFa);
